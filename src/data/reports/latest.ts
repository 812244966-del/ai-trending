...
import { t, type Finding, type MarketSummaryPoint, type TrendJudgment } from "../../lib/report-types";

export const reportDate = "2026-04-14";
...
export const topFindings = keyFindings.filter((item) => topFindingNames.has(item.name));
